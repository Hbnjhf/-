...
if (message.content.startsWith("https://discord.gg/")) {
  ...
  message.author.send(` دانرا تۆش ڕیکلامەکە بکە https://discord.gg/P5dd4jCg`) // لینکی سێرڤەری خۆت لیرە دابنی بە هەتا هەتای بێت
...
client.login("https://discord.gg/P5dd4jCg");//تۆکین لێرە دانێ
